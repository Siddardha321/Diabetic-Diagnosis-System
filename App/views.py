...
def Deploy_8(request): 
    ...
    if request.method == "POST":
        ...
        models = keras.models.load_model(r'C:/Users/Admin/Pictures/LENET.h5')
        data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)
        image = Image.open(r"C:/Users/Admin/Pictures/Phase 2/Deploy/Project/media/" + str(result1)).convert("RGB")
        size = (224, 224)
...
Model = joblib.load(r'C:\Users\Admin\Pictures\DIABETICS.pkl')
...
def Database(request):
    ...
    models = [m for m in models if m.image and hasattr(m.image, 'url')]
